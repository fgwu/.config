...
ubuntu-install:
	sudo apt-get -y install build-essential net-tools emacs git cscope bc mlocate xauth crash wget libncurses-dev python-pip tmux libtool automake libgflags-dev  libboost-all-dev
